...
HD_PWD='d:/zybo_adder/project_1.tmp/myip_adder_v1_0_project/myip_adder_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_adder_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myip_adder_v1_0.tcl -notrace
