...
HD_PWD='d:/zybo_adder/project_1.tmp/myip_adder_v1_0_project/myip_adder_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_adder_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myip_adder_v1_0.tcl
